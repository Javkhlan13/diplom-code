...
const products: ProductType[] = [
    {
        id: 1,
        section: "Бидний тухай",
        link: ['Товч танилцуулга', 'Хичээл', '', 'Бидэнтэй холбогдох'],
    },
    {
        id: 2,
        section: "Дэмжлэг",
        link: ['Тусламж', 'Terms of service', 'Legal', 'Privacy Policy', 'Status']
    }
]

const footer = () => {
    return (
        <div className="bg-[#417cbf] -mt-7" id="footer">
            <div className="mx-auto max-w-2xl pt-64 pb-16 px-4 sm:px-6 lg:max-w-7xl lg:px-8">
                <div className="mt-24 grid grid-cols-1 gap-y-10 gap-x-16 sm:grid-cols-2 lg:grid-cols-12 xl:gap-x-8">
                    ...
                    <div className='col-span-4'>
                        <img src={'/assets/logo/Logo.png'} alt="logo" className='pb-4' />
                        <h3 className='text-white text-lg font-medium leading-9 mb-4 lg:mb-20'> Таны Япон Монголын гүүр </h3>
                    ...
                    <div className='col-span-4'>
                        <h3 className='text-white text-xl font-semibold mb-6'>Бүртгүүлье</h3>
                        <div className="relative text-black focus-within:text-black flex flex-row-reverse">
                            <input type="Email address" name="q" className="py-4 text-sm w-full text-black bg-gray-900 rounded-md pl-4 focus:outline-none bg-[#6f99ca] focus:text-black" placeholder="Майл хаяг" autoComplete="off" />
            ...
            <div className='pb-24 px-4'>
                <h3 className='text-center text-offwhite'>@2019 - Зохиогчийн эрх хуулиар хамгаалагдсан</h3>
            </div>
