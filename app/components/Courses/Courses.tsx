...
//                     {/* FOR DESKTOP VIEW */}
//                     <button onClick={() => setSelectedButton('webdevelopment')} className={"bg-white " + (selectedButton === 'webdevelopment' ? 'text-black border-b-2 border-orange' : 'text-lightgrey') + " pb-2 text-lg hidden sm:block"}>Анхан түвшин</button>
//                     <button onClick={() => setSelectedButton('mobiledevelopment')} className={"bg-white " + (selectedButton === 'mobiledevelopment' ? 'text-black border-b-2 border-orange' : 'text-lightgrey') + " pb-2 text-lg hidden sm:block"}>Анхан ахисан түвшин</button>
//                     <button onClick={() => setSelectedButton('datascience')} className={"bg-white " + (selectedButton === 'datascience' ? 'text-black border-b-2 border-orange' : 'text-lightgrey') + " pb-2 text-lg hidden sm:block"}>Дунд түвшин</button>
//                     <button onClick={() => setSelectedButton('cloudcomputing')} className={"bg-white " + (selectedButton === 'cloudcomputing' ? 'text-black border-b-2 border-orange' : 'text-lightgrey') + " pb-2 text-lg hidden sm:block"}>Ахисан түвшин</button>
...
import { faBook, faUsers, faWrench, faCircleArrowRight } from "@fortawesome/free-solid-svg-icons";
...
export default function Home() {
  return (
    <>
     ...
     <div id='courses-section' className="flex flex-col text-inherit items-center justify-center  bg-[#FBF6F1] p-20 ">
      <h1 className=" text-7xl font-semibold py-10 font-serif text-[#fdbb11]">Манай үндсэн үйл ажиллагаа</h1>

      <div className="flex items-center justify-center h-full gap-10 text-center max-w-[1200px]">


        <div className="flex flex-col items-center justify-center">
          <div className=" flex border border-solid border-zinc-800 rounded-full w-20 h-20 items-center justify-center my-8 ">
            <FontAwesomeIcon icon={faBook} style={{ width: '50px', height: '50px' }} />
          </div>
          <h3 className="font-semibold font-mono">Япон хэлны сургалт</h3>
          <p className="py-8 font-sans"> Япон хэлний сургалтын талаар дэлгэрэнгүй мэдээллийг дэлгэрэнгүй дээр дарж авна уу. </p>
          <button className="bg-[#417cbf] rounded py-2 px-8 text-neutral-50 flex items-center">
  ...
  <FontAwesomeIcon icon={faCircleArrowRight} style={{ width: '16px', height: '16px', marginLeft: '8px' }} />
        ...
        <div className="flex flex-col items-center justify-center">
          <div className=" flex border border-solid border-zinc-800 rounded-full w-20 h-20 items-center justify-center my-8">
            <FontAwesomeIcon icon={faUsers} style={{ width: '50px', height: '50px'  }} />
          </div>
          <h3 className="font-semibold font-mono"> Гэрээт Ажилтан </h3>
          <p className="py-8 font-sans"> Гэрээт ажилтны талаар дэлгэрэнгүй мэдээллийг  дэлгэрэнгүй дээр дарж авна уу. </p>
          <button className="bg-[#417cbf] rounded py-2 px-8 text-neutral-50 flex items-center">
  <span>Дэлгэрэнгүй</span>
  <FontAwesomeIcon icon={faCircleArrowRight} style={{ width: '16px', height: '16px', marginLeft: '8px' }} />
</button>
        ...
        <div className="flex flex-col items-center justify-center">
          <div className=" flex border border-solid border-zinc-800 rounded-full w-20 h-20 items-center justify-center my-8">
            <FontAwesomeIcon icon={faWrench} style={{ width: '50px', height: '50px'  }} />
          </div>
          <h3 className="font-semibold font-mono"> Үндсэн ажилтан </h3>
          <p className="py-8 font-sans"> Үндсэн ажилтны талаар дэлгэрэнгүй мэдээллийг дэлгэрэнгүй дээр дарж авна уу. </p>
          <button className="bg-[#417cbf] rounded py-2 px-8 text-neutral-50 flex items-center">
  <span>Дэлгэрэнгүй</span>
  <FontAwesomeIcon icon={faCircleArrowRight} style={{ width: '16px', height: '16px', marginLeft: '8px' }} />
</button>
