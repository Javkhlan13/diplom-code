...
type Coursetype = {
  ...
  { name: 'Тав тухтай орчин' },
  { name: 'Найрсаг хамт олон' },
  { name: 'Хэлний бэлтгэл сургуулиуд' },
  { name: 'Тусгай ур чадварын шалгалт' },
  { name: 'Сургалтын материалар хангана' },
  { name: 'Сертифкат олгоно' },
]
...
const Dropdown = () => {
  ...
  return (
    <div className="w-full">
      ...
      <h3 className='text-lg text-lightgrey'>СУРГАЛТЫН ТӨВ </h3>
