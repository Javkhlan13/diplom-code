            ...
            <div className="relative px-6 lg:px-8">
                <div className="mx-auto max-w-5xl pt-16 sm:pt-40 sm:pb-24">
                    <div className="text-center">
                        <h1 className="text-4xl font-bold tracking-tight text-blue-700 sm:text-75px md:4px text-[#417cbf]">
                            ЖМ ДРИЙМ
                        </h1>
                        <p className="mt-6 text-lg leading-8 text-black">
                        Япон улсад сурч, хөдөлмөрлөх хүмүүст япон хэлийг зааж сургах, соёлын талаарх мэдээлэл өгч дэмжиж, Монгол Япон 2 улсыг хооронд холбосон гүүр болон ажиллаж байна. 
